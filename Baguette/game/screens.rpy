...
init offset = -1
default persistent.maid_route = False
default persistent.clue = 0
...
label credits:
    ...
    image theend = Text("{size=80}{color=#FFFFFF}The End", text_align=0.5)
...
init python:
    credits = ('Backgrounds', 'chatGPT'),  ('Sprites and CG', 'Theeraphat Chansoontraporn '), ('GUI', 'Skolaztika'), ('Writing', 'Theeraphat Chansoontraporn'), ('Writing', 'Pichanmet Meeta'), ('Writing', 'Sirapob Chormpinta '), ('Writing', 'Pumin Sittiwaranon'), ('Programming', 'Pumin Sittiwaranon'),
    credits_s = "{size=80}{color=#FFFFFF}Le Baguette and Grenouille\n\n"
    c1 = ''
    for c in credits:
        if not c1 == c[0]:
            credits_s += "\n{size=60}" + c[0] + "\n"
